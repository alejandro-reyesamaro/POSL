...
{
    shared_ptr<NQueens> nq(make_shared<NQueens>(6000));
    ...
    shared_ptr<POSL_MetaSolver> posl_ms (make_shared<POSL_MetaSolver>("/home/reyesamaro-a/Documents/POSL/src/testers/test_codes/solver_nqueens_test2.posl", 10, nq));
