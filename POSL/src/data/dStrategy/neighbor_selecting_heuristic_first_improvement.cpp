#include "neighbor_selecting_heuristic_first_improvement.h"
...
NeighborSelectingHeuristicFirstImprovement::NeighborSelectingHeuristicFirstImprovement(shared_ptr<Domain> domain, int dimension)
    : rPair(make_shared<DecisionPair>(make_shared<Solution>(domain, dimension), make_shared<Solution>(domain, dimension)))
{}

shared_ptr<DecisionPair> NeighborSelectingHeuristicFirstImprovement::select(shared_ptr<PSP> psp, shared_ptr<Neighborhood> V)
{
    //cout << "first... " << endl;
