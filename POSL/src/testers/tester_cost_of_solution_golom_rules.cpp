...
string Tester_CostOfSolutionGolomRules::test()
{
    ...
    shared_ptr<Solution> sol(make_shared<Solution>(psp->GetBenchmark()->Variable_Domain(), Tester::Golomb_6_17_c2()));
