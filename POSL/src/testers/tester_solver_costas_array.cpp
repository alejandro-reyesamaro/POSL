...
{
    shared_ptr<CostasArray> ca(make_shared<CostasArray>(18));
    shared_ptr<POSL_MetaSolver> posl_ms (make_shared<POSL_MetaSolver>("../src/testers/test_codes/solver_costas_comm.posl", 10, ca));
