...
{
    shared_ptr<Golfers> g(make_shared<Golfers>(5,3,6));
    ...
    shared_ptr<POSL_MetaSolver> posl_ms (make_shared<POSL_MetaSolver>("../src/testers/test_codes/golfers_communication.posl", 10, g));
