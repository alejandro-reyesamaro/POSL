...
ForNQueensCSS::ForNQueensCSS(shared_ptr<NQueens> nq)
    : CreateSolverStrategy(nq),
      sender_solver(make_shared<POSL_Solver>("s1", nq, make_shared<ComputationStrategy>(make_shared<FactoryComputationStrategy_SA001>
        (
            bench,
      ...
      receiver_solver(make_shared<POSL_Solver>("s1", nq, make_shared<ComputationStrategy>(make_shared<FactoryComputationStrategy_RA001>
        (
            bench,
            make_shared<OM_RandomPermutationGeneration>(bench),
            make_shared<OM_OnePermutationNeighborhood>(bench),
      ...
      single_solver(make_shared<POSL_Solver>("s1", nq, make_shared<ComputationStrategy>(make_shared<FactoryComputationStrategy_A001>
        (
            bench,
            make_shared<OM_RandomPermutationGeneration>(bench),
            make_shared<OM_OnePermutationNeighborhood>(bench),
