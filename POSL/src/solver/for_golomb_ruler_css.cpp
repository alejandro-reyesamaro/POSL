...
ForGolombRulerCSS::ForGolombRulerCSS(shared_ptr<GolombRuler> golomb)
    : CreateSolverStrategy(golomb),
      sender_solver(make_shared<POSL_Solver>(golomb, make_shared<ComputationStrategy>(make_shared<FactoryComputationStrategy_SA002>
        (
            bench,
      ...
      receiver_solver(make_shared<POSL_Solver>(golomb, make_shared<ComputationStrategy>(make_shared<FactoryComputationStrategy_RA002>
        (
            bench,
            make_shared<OM_RandomConfOrderedGeneration>(bench),
            make_shared<OM_OneSortedChangeNeighborhood>(bench),
      ...
      single_solver(make_shared<POSL_Solver>(golomb, make_shared<ComputationStrategy>(make_shared<FactoryComputationStrategy_A002>
        (
            bench,
            make_shared<OM_RandomConfOrderedGeneration>(bench),
            make_shared<OM_OneSortedChangeNeighborhood>(bench),
