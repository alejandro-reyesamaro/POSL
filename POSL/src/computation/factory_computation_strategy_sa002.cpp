#include "factory_computation_strategy_sa002.h"
...
FactoryComputationStrategy_SA002::FactoryComputationStrategy_SA002(shared_ptr<Benchmark> _bench,
    ...
    : FactoryComputationStrategy(_bench, "A002 (sender)")
{
    ...
    shared_ptr<Operator> sec_1(make_shared<SequentialExecOperator>(G_uni, G_sen)); //G_rho);
...
shared_ptr<CompoundModule> FactoryComputationStrategy_SA002::buildModule()
{
    return final_module;
}
