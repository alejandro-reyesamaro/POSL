...
class FactoryComputationStrategy_B001 : public FactoryComputationStrategy
{
    public:
        FactoryComputationStrategy_B001
        (
            ...
            std::shared_ptr<AOM_SelectionFunction> selection_function1,
                std::shared_ptr<AOM_SelectionFunction> selection_function2,
